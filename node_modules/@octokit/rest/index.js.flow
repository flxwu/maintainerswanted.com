declare module "github" {
  ...
  declare class Github {
    ...
    checks: {
      ...
      requestSuites(
        params: ChecksRequestSuitesParams,
        callback?: Callback
      ): Promise<any>,
    ...
    misc: {
      ...
      renderMarkdownRaw(params: EmptyParams, callback?: Callback): Promise<any>
    };
    orgs: {
      addOrgMembership(
    ...
    users: {
      ...
      addEmails(params: EmptyParams, callback?: Callback): Promise<any>,
      addRepoToInstallation(
      ...
      deleteEmails(params: EmptyParams, callback?: Callback): Promise<any>,
      deleteGpgKey(
